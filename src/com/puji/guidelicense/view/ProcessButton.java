...
public abstract class ProcessButton extends FlatButton {
	...
	private void init(Context context, AttributeSet attrs) {
		...
		mCompleteDrawable = (GradientDrawable) getDrawable(
				R.drawable.rect_complete).mutate();
		mCompleteDrawable.setCornerRadius(getCornerRadius());

		mErrorDrawable = (GradientDrawable) getDrawable(R.drawable.rect_error)
				.mutate();
	...
	private void initAttributes(Context context, AttributeSet attributeSet) {
		...
		try {
			mLoadingText = attr
					.getString(R.styleable.ProcessButton_pb_textProgress);
			mCompleteText = attr
					.getString(R.styleable.ProcessButton_pb_textComplete);
			...
			int colorComplete = attr.getColor(
					R.styleable.ProcessButton_pb_colorComplete, green);
			mCompleteDrawable.setColor(colorComplete);

			int red = getColor(R.color.red_error);
			int colorError = attr.getColor(
					R.styleable.ProcessButton_pb_colorError, red);
